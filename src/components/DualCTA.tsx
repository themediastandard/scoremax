      ...
      <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-4">
        ...
        <div className="relative h-56 sm:h-64 rounded-2xl overflow-hidden group">
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-end">
            ...
            <div className="mt-4">
              <Link href="/test-prep/in-person-classes" className="inline-flex items-center justify-center bg-[#c79d3c] text-white px-5 py-2.5 text-sm font-medium hover:bg-[#b08a30] transition-colors font-[family-name:var(--font-playfair)]">Register for SAT Classes</Link>
            </div>
          </div>
        </div>
        ...
        <div className="relative h-56 sm:h-64 rounded-2xl overflow-hidden group">
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-end">
            ...
            <div className="mt-4 flex gap-3 flex-wrap">
              <Link href="/contact" className="inline-flex items-center justify-center bg-[#c79d3c] text-white px-5 py-2.5 text-sm font-medium hover:bg-[#b08a30] transition-colors font-[family-name:var(--font-playfair)]">Book Virtual Tutoring</Link>
