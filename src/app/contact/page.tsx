      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Tell Us About Yourself</div>
            ...
            <form className="space-y-8">
              ...
              <div>
                <label htmlFor="studentName" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <User className="w-5 h-5 text-[#c79d3c]" />
                  </div>
                ...
                <input
                  ...
                  id="studentName"
                  name="studentName"
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#c79d3c]/30 focus:border-[#c79d3c] focus:outline-none transition-colors placeholder-gray-400 text-gray-900 text-sm"
              ...
              <div>
                <label htmlFor="email" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <Mail className="w-5 h-5 text-[#c79d3c]" />
                  </div>
                  Email Address
                </label>
                <input
              ...
              <div>
                <label htmlFor="phone" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 text-[#c79d3c]" />
                  </div>
                  Phone Number
                </label>
                <input
              ...
              <div>
                <label htmlFor="currentCourses" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <BookOpen className="w-5 h-5 text-[#c79d3c]" />
                  </div>
              ...
              <div>
                <label htmlFor="psatScores" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <FileText className="w-5 h-5 text-[#c79d3c]" />
                  </div>
                  Past PSAT Scores
                </label>
                <input
              ...
              <div>
                <label htmlFor="strengths" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <Sparkles className="w-5 h-5 text-[#c79d3c]" />
                  </div>
                ...
                <textarea
                  ...
                  name="strengths"
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#c79d3c]/30 focus:border-[#c79d3c] focus:outline-none transition-colors placeholder-gray-400 text-gray-900 text-sm resize-none"
              ...
              <div>
                <label htmlFor="weaknesses" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <Target className="w-5 h-5 text-[#c79d3c]" />
                  </div>
              ...
              <div>
                <label htmlFor="helpNeeded" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2 flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 flex items-center justify-center flex-shrink-0">
                    <HelpCircle className="w-5 h-5 text-[#c79d3c]" />
                  </div>
              ...
              <div className="pt-8">
                <button
                  type="submit"
                  className="w-full bg-[#c79d3c] text-white px-8 py-4 text-sm font-medium hover:bg-[#b08a30] transition-colors font-[family-name:var(--font-playfair)]"
                >
                  Submit
                </button>
              </div>
