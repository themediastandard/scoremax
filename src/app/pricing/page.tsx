    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-12 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Pricing</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Pay As You Go</div>
            <h2 className="font-[family-name:var(--font-playfair)] text-3xl lg:text-4xl text-gray-900 mb-1">1:1 Tutoring</h2>
            <div className="w-10 h-[2px] bg-[#c79d3c] mx-auto mt-4 mb-5" />
          ...
          <div className="max-w-2xl mx-auto rounded-2xl bg-white border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="px-6 py-4 bg-gray-50/30 border-t border-gray-100">
              <Link href="/book" className="inline-flex items-center justify-center w-full sm:w-auto bg-[#c79d3c] text-white px-6 py-3 text-sm font-medium hover:bg-[#b08a30] transition-colors font-[family-name:var(--font-playfair)]">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Recommended</div>
            ...
            {memberships.map((plan) => (
              <div
                ...
                className={`rounded-2xl border p-8 flex flex-col ${
                  plan.featured
                    ? 'border-[#c79d3c] bg-amber-50/30 shadow-lg relative'
                    : 'border-gray-200 bg-white hover:border-gray-300'
                }`}
              >
                {plan.featured && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="bg-[#c79d3c] text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                <ul className="space-y-3 flex-1 mb-8">
                  {plan.perks.map((perk) => (
                    <li key={perk} className="flex items-start gap-2 text-sm text-gray-600">
                      <Check className="w-4 h-4 text-[#c79d3c] shrink-0 mt-0.5" />
                      {perk}
                    </li>
                  ))}
                </ul>
                <Link
                  ...
                  className={`block text-center py-3 text-sm font-medium transition-colors font-[family-name:var(--font-playfair)] ${
                    plan.featured
                      ? 'bg-[#c79d3c] text-white hover:bg-[#b08a30]'
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="rounded-2xl bg-white border border-gray-100 p-8 shadow-sm">
              <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Short-Term</div>
              <h2 className="font-[family-name:var(--font-playfair)] text-2xl lg:text-3xl text-gray-900 mb-1">Prepaid Packages</h2>
              <div className="w-10 h-[2px] bg-[#c79d3c] mt-4 mb-6" />
            ...
            <div className="rounded-2xl bg-white border border-gray-100 p-8 shadow-sm">
              ...
              <ul className="space-y-2 mb-6 text-sm text-gray-600">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#c79d3c] shrink-0 mt-0.5" /> 2 sessions per week, 2 hours each</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#c79d3c] shrink-0 mt-0.5" /> 32 total contact hours</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#c79d3c] shrink-0 mt-0.5" /> Diagnostics + practice tests included</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#c79d3c] shrink-0 mt-0.5" /> Bonus: 2 hours of 1:1 tutoring</li>
              </ul>
              <div className="mb-6">
                <span className="font-[family-name:var(--font-playfair)] text-3xl text-gray-900">$1,200 – $1,500</span>
              </div>
              <Link href="/test-prep/in-person-classes" className="block text-center py-3 bg-[#c79d3c] text-white text-sm font-medium hover:bg-[#b08a30] transition-colors font-[family-name:var(--font-playfair)]">
                Learn About Classes
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" className="inline-flex items-center justify-center bg-[#c79d3c] text-white px-8 py-3 text-sm font-medium hover:bg-[#b08a30] transition-colors font-[family-name:var(--font-playfair)]">
