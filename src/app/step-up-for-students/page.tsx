    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="pt-32 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Florida Scholarship</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">Partnership</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center items-center gap-16 mb-12">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-[#c79d3c] rounded-circle flex items-center justify-center shadow-lg flex-shrink-0">
            ...
            <div className="text-center">
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                <div className="flex items-center justify-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[#c79d3c]/10 rounded-lg flex items-center justify-center">
                    <span className="text-lg">✓</span>
                  </div>
                  <h3 className="font-[family-name:var(--font-playfair)] text-lg text-gray-900">Partnership Success</h3>
                </div>
                <p className="text-gray-500 text-sm leading-relaxed">
                  <span className="font-semibold text-[#c79d3c]">Free expert tutoring</span> for Step Up scholarship recipients
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="steps" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="uppercase text-xs tracking-widest text-[#c79d3c] font-semibold mb-3">How to Get Started</div>
            <h2 className="font-[family-name:var(--font-playfair)] text-3xl lg:text-4xl text-gray-900 mb-4">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-[#c79d3c]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span className="text-[#c79d3c] text-sm font-bold">1</span>
                </div>
                <div className="flex-1">
                  ...
                  <Link href="https://www.stepupforstudents.org" target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center text-[#c79d3c] font-semibold hover:text-[#b08a30] transition-colors text-sm">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-[#c79d3c]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span className="text-[#c79d3c] text-sm font-bold">2</span>
                </div>
                <div className="flex-1">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-[#c79d3c]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span className="text-[#c79d3c] text-sm font-bold">3</span>
                </div>
                <div className="flex-1">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-start space-x-4 mb-6">
                <div className="w-10 h-10 bg-[#c79d3c]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <span className="text-[#c79d3c] text-sm font-bold">4</span>
                </div>
                <div className="flex-1">
              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-4 py-3 border border-gray-200 focus:ring-2 focus:ring-[#c79d3c] focus:border-gray-200 focus:outline-none transition-all bg-gray-50 focus:bg-white placeholder-gray-400"
                ...
                <div>
                  <label htmlFor="email" className="block font-[family-name:var(--font-playfair)] text-sm text-gray-900 mb-2">Email Address <span className="text-[#c79d3c]">*</span></label>
                  <input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full bg-[#c79d3c] text-white px-6 py-3 text-sm font-medium hover:bg-[#b08a30] transition-colors"
                  >
